...
def comment():
    Comment(body='Trial COmment 3000', disabled=False, user_id=3, bug_id=30).save()
    Comment(body='My Favourite Comments for this bug', disabled=False, user_id=3, bug_id=10).save()
    return jsonify_sqlalchemy(Comment)
